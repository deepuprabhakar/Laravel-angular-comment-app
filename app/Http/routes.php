...
Route::get('/comment', 'ExampleControllers\AngularRoutesController@index');
Route::post('/comment', 'ExampleControllers\AngularRoutesController@store');
Route::get('/getComments', 'ExampleControllers\AngularRoutesController@get');
